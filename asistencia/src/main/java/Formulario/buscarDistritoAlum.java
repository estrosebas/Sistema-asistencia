...
public class buscarDistritoAlum extends javax.swing.JFrame {

    /**
     * Creates new form modificarAlumno
     */
    public buscarDistritoAlum() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Buscar distrito - alumno");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarDistritoAlum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarDistritoAlum().setVisible(true);
            }
        });
    }
