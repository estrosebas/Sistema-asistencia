...
public class eliminarDistritoAlum extends javax.swing.JFrame {

    /**
     * Creates new form modificarAlumno
     */
    public eliminarDistritoAlum() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Eliminar distrito - alumno");
    ...
    private void eliminar() {
        ...
        if (idStr.isEmpty()) {
            ...
            DistritoAlumDAO dao = new DistritoAlumDAO();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminarDistritoAlum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminarDistritoAlum().setVisible(true);
            }
        });
    }
