...
public class modificarDistritoRepre extends javax.swing.JFrame {

    /**
     * Creates new form modificarAlumno
     */
    public modificarDistritoRepre() {
        initComponents();
...
//            Representante representanteActualizado = new Representante(idRepre, dniRepre, nomRepre, apePRe, apeMRe, sexoRepre, idDistritoR, domicilio, ocupacion, lugarTrabajo, correo, idTelefono);
            ...
            DistritoRepreDAO distritoDAO = new DistritoRepreDAO();
            boolean exito = distritoDAO.modificar(DistritoRepreActualizado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modificarDistritoRepre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modificarDistritoRepre().setVisible(true);
            }
        });
    }
